...
def build_planning_user_prompt(
    ...
    return (
        ...
        "IMPORTANT — diversité : n'utilise chaque recette_id qu'une seule fois sur toute "
        "la période (sauf si le pool est trop petit pour un créneau). "
        "N'alterne pas deux plats en boucle (ex. A/B/A/B). "
